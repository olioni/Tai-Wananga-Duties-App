<template>
    <div class="popupImg">
        ...
        <img v-if="selected" id="selected" :style="{filter: overlay}" :src="require('../assets/taiohi-photos/' + name +'.png' )"/>
        <img v-else class="unselected" :src="require('../assets/taiohi-photos/' + name +'.png' )" @click="saveData()"/>
    </div>
</template>
